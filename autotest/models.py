...
class AutotestplatModule(models.Model):
...
class AutotestplatInterfacePerformance(models.Model):
...
class AutotestplatAppTestcase(models.Model):
    id = models.CharField(primary_key=True, max_length=255)
    app_testcase_code = models.CharField(max_length=255, blank=True, null=True)
    app_testcase_name = models.CharField(max_length=255, blank=True, null=True)
    app_testcase_result = models.CharField(max_length=255, blank=True, null=True)
    ...
    product_id = models.CharField(max_length=255, blank=True, null=True)
    app_testcase_step = models.CharField(max_length=255, blank=True, null=True)
    app_testcase_objname = models.CharField(max_length=255, blank=True, null=True)
    app_testcase_findmethod = models.CharField(max_length=255, blank=True, null=True)
    app_testcase_evelement = models.CharField(max_length=255, blank=True, null=True)
    app_testcase_optmethod = models.CharField(max_length=255, blank=True, null=True)
    app_testcase_testdata = models.CharField(max_length=255, blank=True, null=True)
    app_testcase_assertdata = models.CharField(max_length=255, blank=True, null=True)
    app_testcase_stepresult = models.CharField(max_length=255, blank=True, null=True)
    app_testcase_evelementtype = models.CharField(max_length=255, blank=True, null=True)
    run_time = models.CharField(max_length=255, blank=True, null=True)
...
class AutotestplatWebTestcase(models.Model):
    id = models.CharField(primary_key=True, max_length=255)
    web_testcase_code = models.CharField(max_length=255, blank=True, null=True)
    web_testcase_name = models.CharField(max_length=255, blank=True, null=True)
    web_testcase_result = models.CharField(max_length=255, blank=True, null=True)
    tester = models.CharField(max_length=255, blank=True, null=True)
    create_time = models.CharField(max_length=255, blank=True, null=True)
    product_id = models.CharField(max_length=255, blank=True, null=True)
    web_testcase_step = models.CharField(max_length=255, blank=True, null=True)
    web_testcase_objname = models.CharField(max_length=255, blank=True, null=True)
    web_testcase_findmethod = models.CharField(max_length=255, blank=True, null=True)
    web_testcase_evelement = models.CharField(max_length=255, blank=True, null=True)
    web_testcase_optmethod = models.CharField(max_length=255, blank=True, null=True)
    web_testcase_testdata = models.CharField(max_length=255, blank=True, null=True)
    web_testcase_assertdata = models.CharField(max_length=255, blank=True, null=True)
    web_testcase_stepresult = models.CharField(max_length=255, blank=True, null=True)
    web_testcase_evelementtype = models.CharField(max_length=255, blank=True, null=True)
    run_time = models.CharField(max_length=255, blank=True, null=True)
